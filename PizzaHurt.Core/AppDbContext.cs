...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<LogsBk> LogsBks { get; set; }
    ...
    public virtual DbSet<TrackActivityLog> TrackActivityLogs { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LogsBk>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("logs_Bk", "db_owner");
        ...
        {
            entity.HasKey(e => e.GenderId).HasName("PK__TblGende__4E24E9F75EBD3A3C");

            entity.ToTable(tb => tb.HasTrigger("trg_UppercaseGenderName"));

            entity.HasIndex(e => e.GenderId, "IX_ASCCGender");

            entity.HasIndex(e => e.GenderName, "UQ__TblGende__F7C177153322C0C4").IsUnique();
        ...
        modelBuilder.Entity<TrackActivityLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__TrackAct__5E5486481D0CE1B1");
